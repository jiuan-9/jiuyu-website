...
Quiddity是一款 AI 聊天桌面应用（Electron），支持多模型接入、AI 人设定制、多会话管理等功能。本项目为Quiddity创建官方品牌网站，用于展示产品特色、引导用户下载、建立品牌认知。

- **目标用户**：日常使用 AI 助手的普通用户、希望自定义 AI 人设的进阶用户
- **产品价值**：让用户了解Quiddity的独特能力（人设精调、多模型、本地隐私），并方便地获取客户端
...
| 区域 | 模块 | 功能描述 |
|------|------|---------|
| Hero | 首屏横幅 | 大标题 "Quiddity"，副标题 "你的专属 AI 伙伴"，CTA 按钮，动态背景渐变 |
